...
const postData = [{
    ...
    },
    {
        ...
        content: 'There is a difference between authenication and authorization. Authentication means confirming your own identity, whereas authorization means being allowed access to the system.',
        user_id: 2
    },
    {
